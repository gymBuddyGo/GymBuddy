document.addEventListener("DOMContentLoaded", function () {
    ...
    if (registerButton) {
        registerButton.addEventListener("click", async function (e) {
            ...
            try {
                const response = await fetch("https://gymbuddy-su2f.onrender.com/api/auth/register", {
                    method: "POST",
    ...
    if (loginButton) {
        loginButton.addEventListener("click", async function (e) {
            ...
            try {
                const response = await fetch("https://gymbuddy-su2f.onrender.com/api/auth/login", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
